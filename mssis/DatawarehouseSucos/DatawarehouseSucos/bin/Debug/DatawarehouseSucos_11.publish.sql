...
GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Fato_003]...';


GO
ALTER TABLE [dbo].[Fato_003]
    ADD DEFAULT NULL FOR [Custo_Fixo];


GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Fato_004]...';


GO
ALTER TABLE [dbo].[Fato_004]
    ADD DEFAULT NULL FOR [Meta_Faturamento];


GO
PRINT N'Creating Default Constraint unnamed constraint on [dbo].[Fato_005]...';


GO
ALTER TABLE [dbo].[Fato_005]
    ADD DEFAULT NULL FOR [Meta_Custo];
