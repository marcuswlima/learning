...
GO
PRINT N'Rename refactoring operation with key 51ebe8dd-e98b-42ee-b0f2-738dfc1f4aa7 is skipped, element [dbo].[Dim_Fabrica].[Id] (SqlSimpleColumn) will not be renamed to Cod_fabrica';
...
GO
PRINT N'Rename refactoring operation with key ad54f202-af34-4c5b-96a6-2cd2e71f4c3e is skipped, element [dbo].[Dim_Tempo].[Nome_Dis_Semana] (SqlSimpleColumn) will not be renamed to Nome_Dia_Semana';


GO
PRINT N'Rename refactoring operation with key 4991d4ab-3fd5-4b50-a170-7e26a2125426 is skipped, element [dbo].[Dim_Tempo].[Cod_Senestre] (SqlSimpleColumn) will not be renamed to Cod_Semestre';
...
CREATE TABLE [dbo].[Fato_001] (
    ...
    [Cod_Fabrica]        NVARCHAR (50) NOT NULL,
    [Cod_Dia]            NVARCHAR (50) NOT NULL,
    [Faturamento]        FLOAT (53)    NOT NULL,
    [Imposto]            FLOAT (53)    NOT NULL,
    [Custo_Variavel]     FLOAT (53)    NOT NULL,
    [Unidade_vendida]    FLOAT (53)    NOT NULL,
    [Quantidade_Vendida] FLOAT (53)    NOT NULL,
...
END
GO
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '51ebe8dd-e98b-42ee-b0f2-738dfc1f4aa7')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('51ebe8dd-e98b-42ee-b0f2-738dfc1f4aa7')
