...
g++ -c %LIB%\SystemNumeral.cpp  -o %OBJ%\SystemNumeral.o
echo NumeroExtenso.cpp...
g++ -c %LIB%\NumeroExtenso.cpp  -o %OBJ%\NumeroExtenso.o
...
IF %ERRORLEVEL% EQU 0 ( 
    ...
    IF %ERRORLEVEL% EQU 0  (
        g++ -Wextra -Werror %OBJ%\%NOME%.o %OBJ%\NumeroExtenso.o %OBJ%\ObterNumero.o %OBJ%\BarraTitulo.o %OBJ%\PrintArray.o %OBJ%\marcusLib.o %OBJ%\Mathematics.o %OBJ%\SystemNumeral.o -o %OBJ%\%NOME%.exe
        echo linkando tudo...
